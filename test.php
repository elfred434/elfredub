...
<head>
    ...
    <style>
        ...
        .interaction-button.liked-up {
            color: var(--thumbs-up-color);
        }

        .interaction-button.liked-down {
            color: var(--thumbs-down-color);
        }

        .interaction-button.liked-heart {
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="text-end mb-3">
                    <a href="formulaire.php" class="btn btn-primary"><i class="bi bi-plus-circle me-2"></i>Nouvelle Publication</a>
                </div>
                            ...
                            <div class="mt-3 interaction-buttons">
                                <div class="like-section">
                                    ...
                                    <span 
                                        ...
                                        data-type="up"
                                    >
                                        <i class="bi bi-hand-thumbs-up<?php echo $publication['user_liked'] == 1 ? '-fill' : ''; ?>"></i>
                                    ...
                                    <span 
                                        ...
                                        data-type="down"
                                    >
                                        <i class="bi bi-hand-thumbs-down<?php echo $publication['user_liked'] == -1 ? '-fill' : ''; ?>"></i>
                                    </span>
                                    ...
                                    <span 
                                        ...
                                        data-type="heart"
                                    >
                                        <i class="bi bi-heart<?php echo $publication['user_liked'] == 2 ? '-fill' : ''; ?>"></i>
                                    </span>
                                </div>
                                ...
                                <div>
                                    <button 
                                        class="btn btn-outline-secondary btn-commentaires" 
                                        data-publication-id="<?php echo $publication['id']; ?>"
                                    >
